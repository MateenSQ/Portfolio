  ...
  return (
    <div className="App">
      ...
      <div class="darkTheme">
          ...
          <h1>Introduction</h1>
              <p>
                  ...
                  mountains of studying throughout my life and nothing to show for it that I could be truly proud of, despite getting good grades. 
              </p>
                  
              <p>
                  After withdrawing, I contemplated my future, where I remembered learning HTML in middle school (Year 5-8). I researched it,
                  played around and made my first simple HTML page. <strong>I learned, applied and for the first time, made something that 
                  felt real - something I could be proud of</strong>.
              </p>
          ...
          <div class="content container">
              ...
              <p><em>BEWARE:</em> none of the apps linked below are in a dark theme. Prepare your eyes!</p>

              <div class="projects center">

                  <div class="box strikeBuilder">
                      <h3>StrikeBuilder</h3>
                      <p>
                          StrikeBuilder is a an app idea that I had which would serve as a catalogue of a variety of martial art moves. It would also be used to
                          help people create their own combinations which they could then practice in real life. I've made a small dummy version of it
                          It was inspired by a martial arts game called Absolver, which had similar features and allowed players to create their own 
                          move sets.
                      </p>
                  ...
                  <div class="box gardenGenie">
                      <h3>Garden Genie</h3>
                      <p>
                          Garden Genie is an app designed to help anyone of any circumstance to start gardening. It considers a user's time, money and consistency.
                          After 12 weeks of learning Web Dev from scratch, this was our final, 4 week full stack project made with a team of 5 other people I had never even
                          spoken to before. We then presented our app and the journey to people interested in what we had made.
                      </p>
                      <p>
                          The app has a few issues, it gets stuck in an infinite load when the form reaches its capacity. I find completing the form, getting stuck,
                  ...
                  <div class="box businessReporting">
                      ...
                      <p>
                          Since it's technically an inhouse piece of software (despite being available on the web), I want to avoid displaying it. I would be happy to demonstrate
                          aspects of it with my guidance.
                      </p>
                  </div>
              </div>
          </div>
          ...
          <div class="content container">
              ...
              <div>
                  <h2 class="hMargin">Languages</h2>
                  <ul>
                      <li>
                          I want to learn the languages of my parents, starting with Croatian
                          <ul>
                              <li>I create my own materials on Anki with the help of websites and Google translate (<em>I know</em>) since there are so few Croatian learning resources online.</li>
                          </ul>
                      </li>
                      <li>
                          Once I have the spare funds, I want to take online lessons from Croatian speakers via <a href="https://www.italki.com/">Italki</a> so that I can 
                          get actual interactive experiences.
                      </li>
                  </ul>
                  <p>
                      I never learned Croatian growing up. I'd love to visit family in Croatia to for extra learning, but that requires quite a bit 
                      of resources that I'm short on for now.
                  </p>
                  {/* @* I want to learn the languages of my parents, starting with Croatian. I have started creating my own learning materials, since there are so few online. Once I have more resources, I plan to take some online lessons. *@ */}
              </div>
      ...
      {/* @*     <footer class="border-top footer text-muted">
              <div class="container">
                  &copy; 2024 - Portfolio - <a asp-area="" asp-controller="Home" asp-action="Privacy">Privacy</a>
              </div>
          </footer> *@ */}
