...
function Projects({showPage}) {
    ...
    return (
        <main className={`text fade ${showPage ? 'fade-in' : 'fade-out'}`}>
                <h3 className="h3">Here you will find projects I have worked on - click on the images to go to the website! This is the first version of my portfolio site, I am currently solidifying my knowledge with TypeScript so I can rebuild this site using TypeScript and a JS framework I'm unfamiliar with: Angular.js or Vue.js</h3>
