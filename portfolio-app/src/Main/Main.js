...
function Main({showPage}) {
    ...
    return (
        <main className={`text fade ${showPage ? 'fade-in' : 'fade-out'}`}>
                <h3 className="h3">Here you will find projects I have worked on - click on the images to go to the website! This is the first version of my portfolio site, expect changes to come!</h3>
